...
@XmlRootElement(name = "validaUtilizador", namespace = "http://eletronica.votacao/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "validaUtilizador", namespace = "http://eletronica.votacao/", propOrder = {"arg0", "arg1"})
