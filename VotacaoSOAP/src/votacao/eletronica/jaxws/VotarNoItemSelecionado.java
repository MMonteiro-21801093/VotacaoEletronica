...
@XmlRootElement(name = "votarNoItemSelecionado", namespace = "http://eletronica.votacao/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "votarNoItemSelecionado", namespace = "http://eletronica.votacao/", propOrder = {"arg0", "arg1"})
